...
void CPlayerlistCore::SavePlayerlist()
{
	...
	try
	{
		...
		SDK::Output("Aletherium", "Saved playerlist", DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Aletherium", "Save playerlist failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}
...
void CPlayerlistCore::LoadPlayerlist()
{
	...
	try
	{
		...
		if (auto tSub = tRead.get_child_optional("Config"))
		{
			...
			SDK::Output("Aletherium", "Playerlist config not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		...
		if (auto tSub = tRead.get_child_optional("Tags"))
		{
			...
			SDK::Output("Aletherium", "Playerlist tags not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
		...
		if (auto tSub = tRead.get_child_optional("Aliases"))
		{
			...
			SDK::Output("Aletherium", "Playerlist aliases not found", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);

		F::PlayerUtils.m_bLoad = false;
		SDK::Output("Aletherium", "Loaded playerlist", DEFAULT_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
	}
	catch (...)
	{
		SDK::Output("Aletherium", "Load playerlist failed", ALTERNATE_COLOR, OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
	}
}