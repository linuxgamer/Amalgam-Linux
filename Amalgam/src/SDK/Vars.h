...
namespace Vars
{
	...
	NAMESPACE_BEGIN(Aimbot)
		...
		SUBNAMESPACE_BEGIN(Projectile)
			...
			CVar(UseCurvatureFit, "Use curvature fit", false, NOSAVE | DEBUGVAR);
			...
			CVar(UseStabilityMinSamples, "Use stability min samples", false, NOSAVE | DEBUGVAR);
	...
	NAMESPACE_BEGIN(Misc)
		...
		SUBNAMESPACE_BEGIN(Game)
			...
			CVar(VACBypass, "Insecure dialog bypass", true);
